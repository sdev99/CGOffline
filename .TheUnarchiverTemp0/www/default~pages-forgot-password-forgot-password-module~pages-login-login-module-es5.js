              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      this.translateService.get("SHARED_TEXT.CANCEL").subscribe(function (res) {
                                  ...
                                  this.languages.map(function (item) {
                                    buttons.push({
                                      ...
                                      handler: function handler() {
                                        _this2.selectedLanguage = item.code;
                                        localStorage.setItem(_services_enum_service__WEBPACK_IMPORTED_MODULE_9__["EnumService"].LocalStorageKeys.APP_LANGUAGE, _this2.selectedLanguage);

                                        _this2.translateService.use(_this2.selectedLanguage);
                                      }
                                    });
                                  });
                                  buttons.push({
                      ...
                      if (this.loginForm.valid) {
                        ...
                        this.accountService.login(email, password).subscribe(function (data) {
                          ...
                          if (localStorage.getItem(_services_enum_service__WEBPACK_IMPORTED_MODULE_9__["EnumService"].LocalStorageKeys.PUSH_PERMISSION_ALLOWED) === "true") {
                            _this3.sharedDataService.updatePushSettingOnServer(true);
                          } else {
                            _this3.sharedDataService.updatePushSettingOnServer(false);
                          }
                        }, function (_ref) {
