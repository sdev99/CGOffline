...
let UtilService = UtilService_1 = class UtilService {
    ...
    addDynamicFormControlsIfNotExist(section, sectionIndex, questionIndex, question, formGroup, onValueChange = null) {
        ...
        if (question.selectedAnswerTypeId === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].CustomAnswerType.MultipleChoiceSet) {
            const checkboxFormGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({}, {
            ...
            const control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](false, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose(validators));
            ...
            questionLogics.some((logic) => {
                if (_enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.LogicApplicableForQuestionTypes.indexOf(question.selectedAnswerTypeId) !== -1) {
                    ...
                    if (question.selectedAnswerTypeId === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].CustomAnswerType.SingleChoiceSet) {
                        ...
                        const valueToBeCompare = question.answerChoiceAttributes[questionChoiceSetSequence];
                        // Check if condition meet
                        const isSelectedAndMeet = questionChoiceSetTypeID === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.SingleMultipleChoiceOperationType.Selected && (value || value === 'true');
                        const isNotSelectedAndMeet = questionChoiceSetTypeID === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.SingleMultipleChoiceOperationType.NotSelected && !value;
                        isActionMeet = isSelectedAndMeet || isNotSelectedAndMeet;
                    }
                    else {
...
let CustomQuestionsContainerComponent = class CustomQuestionsContainerComponent {
    ...
    shouldShowError(question) {
        if (question.selectedAnswerTypeId === _services_enum_service__WEBPACK_IMPORTED_MODULE_5__["EnumService"].CustomAnswerType.SingleChoiceSet ||
            ...
            question.selectedAnswerTypeId === _services_enum_service__WEBPACK_IMPORTED_MODULE_5__["EnumService"].CustomAnswerType.ConfirmationBox) {
            return true;
        }
        return true;
        // return false;
...
EnumService.QuestionLogic = {
    ...
    LogicApplicableForQuestionTypes: [
        ...
        EnumService_1.CustomAnswerType.ConfirmationBox,
    ],
    ActionType: {
        Show: 1,
        Hide: 2,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/** Ionic CSS Variables **/\n:root {\n  /** primary **/\n  --ion-color-primary: #3880ff;\n  --ion-color-primary-rgb: 56, 128, 255;\n  --ion-color-primary-contrast: #ffffff;\n  --ion-color-primary-contrast-rgb: 255, 255, 255;\n  --ion-color-primary-shade: #3171e0;\n  --ion-color-primary-tint: #4c8dff;\n  /** secondary **/\n  --ion-color-secondary: #3dc2ff;\n  --ion-color-secondary-rgb: 61, 194, 255;\n  --ion-color-secondary-contrast: #ffffff;\n  --ion-color-secondary-contrast-rgb: 255, 255, 255;\n  --ion-color-secondary-shade: #36abe0;\n  --ion-color-secondary-tint: #50c8ff;\n  /** tertiary **/\n  --ion-color-tertiary: #5260ff;\n  --ion-color-tertiary-rgb: 82, 96, 255;\n  --ion-color-tertiary-contrast: #ffffff;\n  --ion-color-tertiary-contrast-rgb: 255, 255, 255;\n  --ion-color-tertiary-shade: #4854e0;\n  --ion-color-tertiary-tint: #6370ff;\n  /** success **/\n  --ion-color-success: #2dd36f;\n  --ion-color-success-rgb: 45, 211, 111;\n  --ion-color-success-contrast: #ffffff;\n  --ion-color-success-contrast-rgb: 255, 255, 255;\n  --ion-color-success-shade: #28ba62;\n  --ion-color-success-tint: #42d77d;\n  /** warning **/\n  --ion-color-warning: #ffc409;\n  --ion-color-warning-rgb: 255, 196, 9;\n  --ion-color-warning-contrast: #000000;\n  --ion-color-warning-contrast-rgb: 0, 0, 0;\n  --ion-color-warning-shade: #e0ac08;\n  --ion-color-warning-tint: #ffca22;\n  /** danger **/\n  --ion-color-danger: #eb445a;\n  --ion-color-danger-rgb: 235, 68, 90;\n  --ion-color-danger-contrast: #ffffff;\n  --ion-color-danger-contrast-rgb: 255, 255, 255;\n  --ion-color-danger-shade: #cf3c4f;\n  --ion-color-danger-tint: #ed576b;\n  /** dark **/\n  --ion-color-dark: #222428;\n  --ion-color-dark-rgb: 34, 36, 40;\n  --ion-color-dark-contrast: #ffffff;\n  --ion-color-dark-contrast-rgb: 255, 255, 255;\n  --ion-color-dark-shade: #1e2023;\n  --ion-color-dark-tint: #383a3e;\n  /** medium **/\n  --ion-color-medium: #92949c;\n  --ion-color-medium-rgb: 146, 148, 156;\n  --ion-color-medium-contrast: #ffffff;\n  --ion-color-medium-contrast-rgb: 255, 255, 255;\n  --ion-color-medium-shade: #808289;\n  --ion-color-medium-tint: #9d9fa6;\n  /** light **/\n  --ion-color-light: #f4f5f8;\n  --ion-color-light-rgb: 244, 245, 248;\n  --ion-color-light-contrast: #000000;\n  --ion-color-light-contrast-rgb: 0, 0, 0;\n  --ion-color-light-shade: #d7d8da;\n  --ion-color-light-tint: #f5f6f9;\n  /** App Primary Color**/\n  --ion-color-app-primary: #8A25B1;\n}\n@media (prefers-color-scheme: dark) {\n  /*\n   * Dark Colors\n   * -------------------------------------------\n   */\n  /*\n   * iOS Dark Theme\n   * -------------------------------------------\n   */\n  /*\n   * Material Design Dark Theme\n   * -------------------------------------------\n   */\n}\n.content-container {\n  display: flex;\n  flex-direction: column;\n  min-height: 100%;\n}\n.content-container .fill-vertical-space {\n  flex: 1;\n}\nion-footer {\n  background-color: #FFFFFF;\n}\nion-label {\n  white-space: normal !important;\n}\n.text-tiny {\n  font-size: 0.7em;\n}\n.text-small {\n  font-size: 0.85em;\n}\n.text-big {\n  font-size: 1.4em;\n}\n.text-huge {\n  font-size: 1.8em;\n}\nion-item {\n  border-top: 1px solid #e8eaf2 !important;\n  border-bottom: 1px solid #e8eaf2 !important;\n  --padding-start: 0;\n  --padding-top: 0;\n  --padding-bottom: 0;\n  --inner-padding-end: 0;\n  padding: 10px 23px;\n}\nion-item ion-label {\n  font-family: IBM Plex Sans;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 17px;\n  line-height: 22px;\n  color: #171538;\n  white-space: pre !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let AppComponent = class AppComponent {
    constructor(platform, ngZone, statusBar, uniqueDeviceID, sharedDataService, utilService, observablesService, navController, screenOrientation, accountService, apiService, router, badge, device, translateService) {
        ...
        this.appSettingLoaded = (isDeviceAssignedForDedicatedMode, data = null) => {
            this.ngZone.run(() => {
                ...
                if (isDeviceAssignedForDedicatedMode) {
                    ...
                    if (!this.sharedDataService.dedicatedMode && this.accountService.userValue && ((_a = this.accountService.userValue) === null || _a === void 0 ? void 0 : _a.userId)) {
        ...
        this.checkDeviceForDeticatedMode = (callBack) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.apiService.getDeviceEntityDetails(this.sharedDataService.deviceUID).subscribe((data) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                var _a, _b, _c;
            ...
            if (!this.sharedDataService.isNavigationTypeDeepLink) {
                ...
                if ((user === null || user === void 0 ? void 0 : user.userId) && !user.isMobileSessionExpiration) {
                    ...
                    if (!this.sharedDataService.isLoginAfterAppOpen && (user === null || user === void 0 ? void 0 : user.companyID)) {
                        this.accountService.checkMobileSessionExpirationSetting(user === null || user === void 0 ? void 0 : user.companyID).subscribe((response) => {
                            var _a;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfirmBoxFieldComponent", function() { return ConfirmBoxFieldComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_confirm_box_field_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./confirm-box-field.component.html */ "BCO8");
/* harmony import */ var _confirm_box_field_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confirm-box-field.component.scss */ "EyFw");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _services_util_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/util.service */ "2Rin");
/* harmony import */ var _services_shared_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/shared-data.service */ "msgi");
...
let ConfirmBoxFieldComponent = class ConfirmBoxFieldComponent {
    constructor(sharedDataService) {
        this.sharedDataService = sharedDataService;
        this.UtilService = _services_util_service__WEBPACK_IMPORTED_MODULE_4__["UtilService"];
    }
...
ConfirmBoxFieldComponent.ctorParameters = () => [
    { type: _services_shared_data_service__WEBPACK_IMPORTED_MODULE_5__["SharedDataService"] }
];
...
ConfirmBoxFieldComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
...
/* harmony import */ var _confirm_box_field_confirm_box_field_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./confirm-box-field/confirm-box-field.component */ "XGPL");
...
ComponentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _confirm_box_field_confirm_box_field_component__WEBPACK_IMPORTED_MODULE_40__["ConfirmBoxFieldComponent"],
...
let SharedDataService = class SharedDataService {
        ...
        this.getCheckinDetails = (userId, apiService) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (userId && this.checkInForLocation) {
                ...
                if (ifAlreadyCheckedinPlace) {
                    ...
                    this.utilService.presentLoadingWithOptions();
                    apiService.getCheckInDetails(userId, this.checkInForLocation.locationID).subscribe((response) => {
                        var _a, _b;
                        this.utilService.hideLoading();
            ...
            if (userId && this.dedicatedModeLocationUse) {
                ...
                apiService.getCheckInDetails(userId, entityId).subscribe((response) => {
                    ...
                    if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                        ...
                        if (this.dedicatedModeProcessType === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].DedicatedModeProcessTypes.CheckinOut && this.checkinoutDmAs === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].CheckInType.QrCode) {
        ...
        this.submitFormAnswers = (apiService, formGroup, formBuilderDetail, personalModeLoggedUser, callBack, havExposure = null, workPermitAnswer = null, attachemtUploaded = {}) => {
            ...
            sections.map((section, sectionIndex) => {
                if (this.utilService.shouldShowSection(section)) {
                    ...
                    if ((sectionFormattedObject.answerData && sectionFormattedObject.answerData.length > 0) ||
            ...
            apiService.saveFormAnswers(submitAnswersObject).subscribe((response) => {
                ...
                if (this.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.Activity ||
                    ...
                    this.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.CurrentCheckinWorkPermit ||
                                        ...
                                        if (control && control.value) {
                                            ...
                                            this.utilService
                                                ...
                                                if (isVideo) {
                                                    ...
                                                    apiService.formPhotoOrVideoUpload(file, fileName).subscribe((response) => {
    ...
    submitPersonalModeSignoffData(apiService) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const isWorkPermitCurrentCheckin = this.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.WORKPERMIT_FORM_CURRENT_CHECKIN || this.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.WORK_PERMIT_DM;
            const isworkPermitActivity = this.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.FORM_ACTIVITY && ((_b = (_a = this.signOffFormDetail) === null || _a === void 0 ? void 0 : _a.formData) === null || _b === void 0 ? void 0 : _b.formType) === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].FormTypes.WORK_PERMIT;
            if (this.dedicatedMode) {
            ...
            apiService.insertPersonalModeSignOffDetails(this.signOffDetailsPostData).subscribe((response) => {
                this.utilService.hideLoading();
                if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                    if (this.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.FORM_ACTIVITY || this.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.DOCUMENT_ACTIVITY) {
        ...
        if (this.checkInDetail) {
            ...
            if (inductionItems && inductionContentItemIndex < inductionItems.length - 1) {
                ...
                if (inductionContentItem.contentType === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].InductionContentTypes.FORM) {
                    if (this.dedicatedMode) {
                        this.utilService.presentLoadingWithOptions();
                        this.apiServiceRerence.getDedicatedModeSignOffFormDetail(inductionContentItem.formID).subscribe((response) => {
                            this.utilService.hideLoading();
                            if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                        ...
                        this.utilService.presentLoadingWithOptions();
                        this.apiServiceRerence.getSignOffFormDetail(userId, inductionContentItem.formID, LocationID, ProjectID, InventoryID).subscribe((response) => {
                            this.utilService.hideLoading();
                            if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                                this.viewFormFor = _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.Induction;
                                this.signOffFormDetail = response.Result;
