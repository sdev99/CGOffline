  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-dashboard-dashboard-module"], {
    ...
    function RN(module, __webpack_exports__, __webpack_require__) {
      ...
      DashboardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardPageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_8__["PipesModule"]],
    ...
    function ckw(module, __webpack_exports__, __webpack_require__) {
      ...
      var DashboardPage = /*#__PURE__*/function () {
        function DashboardPage(navCtrl, apiService, utilService, accountService, sharedDataService, observablesService) {
          var _this = this;
          ...
          this.getActivityList = function () {
            ...
            _this.apiService.getActivityList((_a = _this.user) === null || _a === void 0 ? void 0 : _a.userId).subscribe(function (response) {
              if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                if (result) {
                  _this.activityList = result.activityList;
                  _this.activityOverviewData = result.activityOverviewData;
                  _this.sharedDataService.activityList = result.activityList;
                  _this.sharedDataService.activityOverviewData = result.activityOverviewData;
                }
              }
              ...
              _this.activityOverviewData = null;
              _this.sharedDataService.activityList = null;
              _this.sharedDataService.activityOverviewData = null;
        ...
        _createClass(DashboardPage, [{
          ...
          value: function ngOnInit() {
            ...
            if (!this.sharedDataService.dedicatedMode) {
              this.apiService.getGlobalDirectories((_a = this.user) === null || _a === void 0 ? void 0 : _a.companyFolderName).subscribe(function (response) {
                if (response) {
                  _this2.sharedDataService.globalDirectories = response;
              ...
              this.observablesService.getObservable(_services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ObserverKeys.ACTIVITY_COMPLETED).subscribe(function () {
          ...
          key: "testFormPreview",
          value: function testFormPreview() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var _this3 = this;

              var formID, formVersionID;
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      this.apiService.getFormBuilderDetails(formID, formVersionID).subscribe(function (response) {
                        _this3.sharedDataService.formBuilderDetails = response.Result;

                        _this3.navCtrl.navigateForward(["/form-custom"]);
          ...
          key: "openActivityDetail",
          value: function openActivityDetail(activity) {
    ...
    function eaW(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | checkin-list-checkin-list-module */
          "checkin-list-checkin-list-module").then(__webpack_require__.bind(null,
          /*! ../checkin-list/checkin-list.module */
