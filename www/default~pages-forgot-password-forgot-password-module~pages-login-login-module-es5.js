(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-forgot-password-forgot-password-module~pages-login-login-module"], {
    ...
    function bP1B(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_demo_data_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(utilService, navCtrl, actionSheetController, sharedDataService, accountService, translateService) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function ngOnInit() {
            ...
            if (((_a = this.accountService.userValue) === null || _a === void 0 ? void 0 : _a.userId) && !this.accountService.userValue.isMobileSessionExpiration) {
              this.navCtrl.navigateRoot("/tabs/dashboard", {
                replaceUrl: true
              });
            }

            if (_services_util_service__WEBPACK_IMPORTED_MODULE_6__["UtilService"].isLocalHost()) {// setTimeout(() => {
                      ...
                      this.languages.map(function (item) {
                        buttons.push({
                          ...
                          handler: function handler() {
                            _this.selectedLanguage = item.code;
                            localStorage.setItem(_services_enum_service__WEBPACK_IMPORTED_MODULE_9__["EnumService"].LocalStorageKeys.APP_LANGUAGE, _this.selectedLanguage);

                            _this.translateService.use(_this.selectedLanguage);
                          }
                        });
                      });
                      buttons.push({
                  ...
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      if (this.loginForm.valid) {
                        ...
                        this.accountService.login(email, password).subscribe(function (data) {
                          _this2.utilService.hideLoading();

                          _this2.sharedDataService.isLoginAfterAppOpen = true;
                          ...
                          if (localStorage.getItem(_services_enum_service__WEBPACK_IMPORTED_MODULE_9__["EnumService"].LocalStorageKeys.PUSH_PERMISSION_ALLOWED) === "true") {
                            _this2.sharedDataService.updatePushSettingOnServer(true);
                          } else {
                            _this2.sharedDataService.updatePushSettingOnServer(false);
                          }
                        }, function (_ref) {
...
//# sourceMappingURL=default~pages-forgot-password-forgot-password-module~pages-login-login-module-es5.js.map