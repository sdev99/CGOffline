...
let FormsDmPage = class FormsDmPage {
    ...
    ionViewWillEnter() {
        this.sharedDataService.dedicatedModeProcessType =
            _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].DedicatedModeProcessTypes.Form;
        ...
        this.apiService.getDedicatedModeSignOffFormDetail(item.formID).subscribe((response) => {
            ...
            if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                this.sharedDataService.viewFormFor =
                    _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ViewFormForType.FormDM;
                this.sharedDataService.signOffFormDetail = response.Result;
                this.sharedDataService.dedicatedModeTempAuthFor =
                    _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].DedicatedModeTempAuthType.Form;
