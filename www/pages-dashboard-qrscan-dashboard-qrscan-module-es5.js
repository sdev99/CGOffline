    ...
    function Ogxv(module, __webpack_exports__, __webpack_require__) {
      ...
      var DashboardQrscanPage = /*#__PURE__*/function () {
        function DashboardQrscanPage(navCtrl, qrScanner, accountService, apiService, utilService, sharedDataService, actionSheetController, activatedRoute) {
          ...
          this.getQrDetailForDedicatedMode = function (qrCode) {
            _this.utilService.presentLoadingWithOptions();

            _this.apiService.getUserByQRCode(qrCode).subscribe(function (response) {
              ...
              if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                if ((userDetail === null || userDetail === void 0 ? void 0 : userDetail.userId) && (userDetail === null || userDetail === void 0 ? void 0 : userDetail.userId) !== _services_static_data_service__WEBPACK_IMPORTED_MODULE_13__["StaticDataService"].userDefaultGuid) {
                  _this.openNextScreenForDedicatedMode(userDetail);
                } else {
                  _this.utilService.showAlert("This user is not valid for any operation.", "", function () {
                    _this.scan();
                  });
                }
              }
              ...
              _this.utilService.showAlert(error.message || error, "Not found!", function () {
                _this.scan();
              });
            });
          };

          this.getQrDetailForPersonalMode = function (qrCode) {
            _this.utilService.presentLoadingWithOptions();

            _this.apiService.getEntityByQRCode(qrCode).subscribe(function (response) {
              _this.utilService.hideLoading();
              ...
              if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                if (locationItem && locationItem.locationID && locationItem.locationName) {
                  _this.openNextScreenForPersonalMode(locationItem);
                } else {
                  _this.utilService.showAlert("This QR code is not valid for any records.", "", function () {
                    _this.scan();
                  });
                }
              }
          ...
          this.openNextScreenForDedicatedMode = function (detail) {
          ...
          this.openNextScreenForPersonalMode = function (detail) {
            var _a;
        ...
        _createClass(DashboardQrscanPage, [{
          ...
          value: function ngOnInit() {
            ...
            var QrCodeTestingInLocalHostFor = "user";
            ...
            if (QrCodeTestingInLocalHostFor && _services_util_service__WEBPACK_IMPORTED_MODULE_10__["UtilService"].isLocalHost()) {
              setTimeout(function () {
                switch (QrCodeTestingInLocalHostFor) {
                  case "document":
                    _this2.checkQrCode("0f75e6e3-8215-4186-92bf-ca0971b337b7");

                    break;

                  case "form":
                    _this2.checkQrCode("e37f99b2-cda6-4b19-b3e6-ba37a41ffd60");

                    break;

                  case "form2":
                    _this2.checkQrCode("6dadd75e-cb62-484d-a9be-deaab282761d");

                    break;

                  case "form_othercompany":
                    _this2.checkQrCode("87b71cae-476a-4c08-9c63-f24ef7970f89\n");

                    break;

                  case "location":
                    _this2.checkQrCode("e165d1a3-a0a9-4b95-a543-8049b440c56d");

                    break;

                  case "location2":
                    _this2.checkQrCode("78312786-35ab-4c9e-969e-6f7673ed7a5e");

                    break;

                  case "location3":
                    _this2.checkQrCode("3d663253-09ab-4299-a891-74fb1961d78c");

                    break;

                  case "user":
                    _this2.checkQrCode("1b5ee704-21f6-4e91-9544-0f2a6abd7aed");
                      ...
                      checkedInPlaces.map(function (item) {
                        buttons.push({
                          ...
                          handler: function handler() {
                            _this4.sharedDataService.currentSelectedCheckinPlace = item;

                            if (getEntityIds.FormID > 0) {
                              _this4.openForm(getEntityIds.FormID);
                            } else if (getEntityIds.DocumentID > 0) {
                              _this4.openDocument(getEntityIds.DocumentID);
                            }
                          }
                        });
                      });
                    ...
                    case 0:
                      ...
                      this.apiService.getActivitySignOffDocumentDetail(documentID).subscribe(function (response) {
                        ...
                        if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ApiResponseCode.RequestSuccessful) {
                          ...
                          _this5.navCtrl.navigateForward(["/document-openchoice"], {
                            queryParams: {
                        ...
                        _this5.utilService.showAlert(error.message || error, "Not found!", function () {
                          _this5.scan();
                        });
                  ...
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      ...
                      this.apiService.getSignOffFormDetail((_a = this.user) === null || _a === void 0 ? void 0 : _a.userId, formID, place === null || place === void 0 ? void 0 : place.locationID, place === null || place === void 0 ? void 0 : place.projectID, place === null || place === void 0 ? void 0 : place.inventoryItemID).subscribe(function (response) {
                        ...
                        if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ApiResponseCode.RequestSuccessful) {
                          _this6.sharedDataService.viewFormFor = _services_enum_service__WEBPACK_IMPORTED_MODULE_8__["EnumService"].ViewFormForType.CurrentCheckin;
