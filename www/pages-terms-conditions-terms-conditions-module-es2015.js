...
let TermsConditionsPage = class TermsConditionsPage {
    constructor(navCtrl, apiService, utilService, sanitizer) {
        ...
        this.getTermsAndConditions = () => {
            this.loading = true;
            this.apiService.getTermsOfServices().subscribe((data) => {
                this.loading = false;
