  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
                    ...
                    if (section.isAccidentReportSection && question.selectedAnswerTypeId === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].CustomAnswerType.LocationSelection) {
                      ...
                      if (_this3.shouldShowSection(section) && _this3.shouldShowQuestion(question)) {
                        _this3.addDynamicFormControlsIfNotExist(section, sectionIndex, questionIndex, question, formGroup, function (value) {
                          _this3.checkAndApplyLogic(question, value, formGroup, sections);
                        });
        ...
        _createClass(UtilService, [{
          ...
          value: function addDynamicFormControlsIfNotExist(section, sectionIndex, questionIndex, question, formGroup) {
            ...
            if (question.selectedAnswerTypeId === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].CustomAnswerType.MultipleChoiceSet) {
              ...
              var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose(validators));
            ...
            if (question.allowQuestionLogic) {
                ...
                if (_enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.LogicApplicableForQuestionTypes.indexOf(question.selectedAnswerTypeId) !== -1) {
                  if (logic.questionActionTypeID === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.ActionType.MarkAsFailed) {
                    ...
                    if (sectionIndex >= 0) {
                      ...
                      sections.map(function (sectionItem, sectionKey) {
                        ...
                        if (sectionKey === sectionIndex + duplicateSectionCount) {
                          if (sectionIndex >= 0 && questionIndex >= 0) {
                            ...
                            sectionItem.questions.some(function (questionItem, questionKey) {
                    ...
                    if (logic.questionActionTypeID === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.ActionType.Show) {
                      ...
                      if (sectionObject) {
                        ...
                        sections[currentIndexOfSection].questions.map(function (questionInner, key) {
                          var uniquePreString = question.questionId + '' + logic.questionLogicId;
              ...
              questionLogics.map(function (logic) {
                if (_enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.LogicApplicableForQuestionTypes.indexOf(question.selectedAnswerTypeId) !== -1) {
                  ...
                  if (isActionMeet) {
                    _this6.applyLogicOn(question, logic, sections);
                  }
                }
              });
          ...
          key: "applyLogicOn",
          value: function applyLogicOn(question, logic, sections) {
            if (logic.questionActionTypeID === _enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.ActionType.MarkAsFailed) {
              ...
              if (sectionIndex >= 0) {
                var duplicateSectionCount = 0;
                sections.some(function (sectionItem, sectionKey) {
                  if (sectionItem[_enum_service__WEBPACK_IMPORTED_MODULE_3__["EnumService"].QuestionLogic.ActionTypeForForm.Duplicate]) {
                    duplicateSectionCount++;
                  }
      ...
      var CustomQuestionsContainerComponent = /*#__PURE__*/function () {
        ...
        _createClass(CustomQuestionsContainerComponent, [{
          ...
          value: function shouldShowError(question) {
            if (question.selectedAnswerTypeId === _services_enum_service__WEBPACK_IMPORTED_MODULE_5__["EnumService"].CustomAnswerType.SingleChoiceSet || question.selectedAnswerTypeId === _services_enum_service__WEBPACK_IMPORTED_MODULE_5__["EnumService"].CustomAnswerType.MultipleChoiceSet) {
              return true;
            }
    ...
    function AIDl(module, __webpack_exports__, __webpack_require__) {
      ...
      EnumService.QuestionLogic = {
        ...
        LogicApplicableForQuestionTypes: [EnumService_1.CustomAnswerType.SingleChoiceSet, EnumService_1.CustomAnswerType.MultipleChoiceSet, EnumService_1.CustomAnswerType.NumberFieldInteger, EnumService_1.CustomAnswerType.NumberFieldDecimal, EnumService_1.CustomAnswerType.DateTimeField, EnumService_1.CustomAnswerType.DateField, EnumService_1.CustomAnswerType.TimeField],
        ActionType: {
          Show: 1,
          Hide: 2,
          Duplicate: 3,
          ...
          value: function login() {
            ...
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].apiUrl, "/").concat(_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiMethods.UserSignIn), {
              ...
              if (data.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                _this33.userSubject.next(userInfo);

                if (userInfo.mobileAppLanguageID) {
                  _this33.sharedDataService.currentLanguageId = userInfo.mobileAppLanguageID;
                }
          ...
          value: function getUserProfile(userId) {
            ...
            return this.http.get("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].apiUrl, "/").concat(_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiMethods.GetUserProfileById, "/").concat(userId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
              if (data.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                _this35.sharedDataService.userProfile = userProfile;
                _this35.sharedDataService.currentLanguageId = userProfile === null || userProfile === void 0 ? void 0 : userProfile.mobileAppLanguageID;
                return userProfile;
              }
          ...
          value: function newAccountSetup(body) {
            ...
            return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].apiUrl, "/").concat(_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiMethods.AccountSetup), Object.assign({
              ...
              if (data.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                _this36.userSubject.next(userInfo);
          ...
          value: function logout(userId) {
            ...
            return this.http["delete"]("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].apiUrl, "/").concat(_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiMethods.UserDeviceDelete, "/").concat(userId), option).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (data) {
              if (data.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiResponseCode.RequestSuccessful) {
                ...
                _this37.userSubject.next(null);

                if (navigateToLogin) {
                  _this37.navController.navigateBack(['login'], {
                    replaceUrl: true
                  });
      ...
      var PhotoFieldComponent = PhotoFieldComponent_1 = /*#__PURE__*/function () {
        function PhotoFieldComponent(photoService, sanitizer, mediaCapture, navCtrl, sharedDataService, actionSheetController) {
          ...
          this.openImageAnnotation = function (photo) {
            _this38.sharedDataService.isOpenImageAnnotation = true;

            _this38.sharedDataService.setAnnotationImage(photo);

            _this38.sharedDataService.onAnnotationImageDone = function (image) {
              _this38.photoAdded(image);
            };

            _this38.navCtrl.navigateForward(['/image-annotation']);
          };
        }
        ...
        _createClass(PhotoFieldComponent, [{
          ...
          value: function addPhotoFromCamera() {
            ...
            this.photoService.takePhotoFromCamera(function (photo) {
              _this39.isVideo = false;

              _this39.openImageAnnotation(photo);
            });
          }
        }, {
          ...
          value: function addVideoFromCamera() {
            ...
            this.mediaCapture.captureVideo(options).then(function (data) {
              _this40.isVideo = true;
              var capturedFile = data[0];
              var videoUrl = capturedFile.fullPath;
              _this40.videoUrl = _capacitor_core__WEBPACK_IMPORTED_MODULE_11__["Capacitor"].convertFileSrc(videoUrl);

              _this40.photoAdded(videoUrl);
            }, function (err) {
              console.error(err);
            });
          }
                    ...
                    case 0:
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          icon: 'camera-outline',
                          handler: function handler() {
                            _this41.addPhotoFromCamera();
                          }
                        }, {
                          text: 'Video',
                          icon: 'videocam-outline',
                          handler: function handler() {
                            _this41.addVideoFromCamera();
                          }
                        }, {
                          text: 'Cancel',
                          icon: 'close',
          ...
          value: function addPhotoFromLibrary() {
            ...
            this.photoService.takePhotoFromGallery(function (photo) {
              if (photo.isVideo) {
                ...
                _this42.isVideo = false;

                _this42.openImageAnnotation(photo);
              }
            }, true);
          }
        }, {
        ...
        _createClass(TopnavigationsSegmentsDmComponent, [{
          ...
          value: function showSearchBar() {
            ...
            this.ngZone.run(function () {
              _this43.searchBarShow = !_this43.searchBarShow;

              _this43.searchbarShowHide.emit(_this43.searchBarShow);
            });
          }
        }]);
      ...
      var SharedDataService = /*#__PURE__*/function () {
        function SharedDataService(router, platform, file, fileTransfer, navCtrl, observablesService, utilService, screenOrientation) {
          ...
          this.configureForPushNotification = function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this44, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee26() {
              var _this45 = this;
                    ...
                    case 4:
                      ...
                      return PushNotifications.requestPermission().then(function (result) {
                        if (result.granted) {
                          ...
                          _this45.registerForPushNotification();
                        } else {
                          ...
                          _this45.updatePushSettingOnServer(false);
                        }
                      });
                        ...
                        if (notification.actionId === "tap") {
                          ...
                          switch (notificationData.action) {
                            ...
                            case _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].NotificationActionType.ActivityOverdue:
                              if (!_this45.dedicatedMode && _this45.getLoggedInUser() && _this45.getLoggedInUser().userId) {
                                setTimeout(function () {
                                  var contentlink = notificationData.contentlink;
                                  var activityId = contentlink.split("_").pop();
                                  var activityList = _this45.activityList;
                                  ...
                                  _this45.currentActivityOpen = currentActivityOpen;
                                  console.log("Push currentActivityOpen", currentActivityOpen);

                                  _this45.navCtrl.navigateForward(["/activity-detail"]);
                                }, 100);
                              }
          ...
          this.registerForPushNotification = function () {
            ...
            _this44.updatePushSettingOnServer(true);
          };

          this.updatePushSettingOnServer = function (isEnable) {
            var _a, _b;

            if (_this44.dedicatedMode) {
              _this44.apiServiceRerence.updatePushNotification({
                isPushNotification: isEnable
              }, _this44.deviceUID).subscribe(function () {});
            } else {
              if ((_a = _this44.getLoggedInUser()) === null || _a === void 0 ? void 0 : _a.userId) {
                _this44.apiServiceRerence.updatePushNotification({
                  isPushNotification: isEnable
                }, (_b = _this44.getLoggedInUser()) === null || _b === void 0 ? void 0 : _b.userId).subscribe(function () {});
              }
            }
          };
          /**
          ...
          this.getCurrentCheckedInEntityName = function () {
            return _this44.getEntityName(_this44.dedicatedModeLocationUse);
          };
          /**
           * For dedicated mode
           */
          ...
          this.getCheckinDetails = function (userId, apiService) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this44, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee27() {
              var _this46 = this;
                      ...
                      if (userId && this.checkInForLocation) {
                        if (this.checkedInPlaces) {
                          this.checkedInPlaces.map(function (place) {
                            var entityIds = _this46.utilService.getRelevantEntityId(_this46.checkInForLocation.locationID);
                        ...
                        if (ifAlreadyCheckedinPlace) {
                          ...
                          apiService.getCheckInDetails(userId, this.checkInForLocation.locationID).subscribe(function (response) {
                            ...
                            if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                              _this46.checkInDetail = response.Result;
                              _this46.checkInPostData = {
                                ...
                                projectID: _this46.checkInDetail.checkInEntityDetail.projectID,
                                inventoryItemID: _this46.checkInDetail.checkInEntityDetail.inventoryItemID,
                                locationID: _this46.checkInDetail.checkInEntityDetail.locationID
                              };

                              _this46.navCtrl.navigateForward(["/checkinout-confirm"], {
                                queryParams: {
                                  headerTitle: "Check In",
                                  title: "You are checking in",
                                  subtitle: _this46.checkInForLocation.locationName,
                                  buttonTitle: "Check In Now",
                                  nextPageData: JSON.stringify({
                                    locationDetail: JSON.stringify(_this46.checkInForLocation)
                                  }),
                            ...
                            if (errorField.indexOf("SimultaneousCheckIn") !== -1) {
                              _this46.navCtrl.navigateForward(["/checkin-fail"], {
                                queryParams: {
          ...
          this.getCheckinDetailsForDedicatedMode = function (userId, apiService) {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this44, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee28() {
              var _this47 = this;

              var entityId, nextScreen;
                      ...
                      if (userId && this.dedicatedModeLocationUse) {
                        ...
                        apiService.getCheckInDetails(userId, entityId).subscribe(function (response) {
                          ...
                          if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                            ...
                            if (_this47.dedicatedModeProcessType === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].DedicatedModeProcessTypes.CheckinOut && _this47.checkinoutDmAs === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].CheckInType.QrCode) {
                            ...
                            if (canUserCheckinToLocation) {
                              ...
                              _this47.checkInPostData = {
                                ...
                                isGuestReturning: false,
                                projectID: _this47.dedicatedModeLocationUse.projectID,
                                inventoryItemID: _this47.dedicatedModeLocationUse.inventoryItemID,
                                locationID: _this47.dedicatedModeLocationUse.locationID
                              };

                              _this47.processCheckinDetailsStepInitial(apiService, false);
                            }
                          }
                        }, function (error) {
                          _this47.utilService.hideLoading();

                          _this47.processCheckInError(error, nextScreen);
                        });
                      }
          ...
          this.getCheckinDetailsGuest = function (apiService) {
            ...
            var entityId = _this44.utilService.getEntityIdFromId(_this44.dedicatedModeLocationUse);

            var nextScreen = _this44.dedicatedMode ? "/dashboard-dm" : "/tabs/dashboard";
            var dedicatedModeDeviceDetailData = _this44.dedicatedModeDeviceDetailData;
            var dedicatedModeGuestDetail = _this44.dedicatedModeGuestDetail;
            var dedicatedModeLocationUse = _this44.dedicatedModeLocationUse;

            _this44.utilService.presentLoadingWithOptions();
            ...
            apiService.getCheckInDetails_Guest(dedicatedModeGuestDetail.guestPhone || "", dedicatedModeGuestDetail.guestFirsName || "", dedicatedModeGuestDetail.guestMiddleName || "", dedicatedModeGuestDetail.guestLastName || "", entityId).subscribe(function (res) {
              ...
              _this44.utilService.hideLoading();

              if (res.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                _this44.checkInDetail = res.Result;
                _this44.checkInPostData = {
                  checkInLatitude: (_a = _this44.myCurrentGeoLocation) === null || _a === void 0 ? void 0 : _a.coords.latitude,
                  checkInLongitude: (_b = _this44.myCurrentGeoLocation) === null || _b === void 0 ? void 0 : _b.coords.longitude,
                ...
                _this44.processCheckinDetailsStepInitial(apiService, true);
              }
            }, function (error) {
              _this44.utilService.hideLoading();

              _this44.processCheckInError(error, nextScreen);
            });
          };
          ...
          this.submitFormAnswers = function (apiService, formGroup, formBuilderDetail, personalModeLoggedUser, callBack) {
            ...
            var selectedLanguageID = _this44.getLanguageIdForForm();
              ...
              if (_this44.utilService.shouldShowSection(section)) {
                ...
                if (section.isRiskAssessmentSection) {
                  ...
                  tasks.map(function (task) {
                    if (_this44.utilService.shouldShowQuestion(task)) {
                  ...
                  var questions = section.questions;
                  questions.map(function (question, questionIndex) {
                    if (_this44.utilService.shouldShowQuestion(question)) {
                          ...
                          switch (question.questionDisplayOrder) {
                            ...
                            case _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].AccidentFormFieldOrder.AccidentLocation:
                              ...
                              if (placeNotintheList.value) {
                                ...
                                var entityIds = _this44.utilService.getRelevantEntityId(control.value);
            ...
            apiService.saveFormAnswers(submitAnswersObject).subscribe(function (response) {
              ...
              if (_this44.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.Activity || _this44.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.CurrentCheckin || _this44.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.CurrentCheckinWorkPermit || _this44.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.FormDM || _this44.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.WorkPermitDM) {
                _this44.workPermitAnswer = workPermitAnswer;

                _this44.startFormSignOffProcess(userId, apiService, response.Result);
              } else if (_this44.viewFormFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.Induction) {
                if (_this44.checkInPostData) {
                  _this44.checkInPostData.inductionFormContent = response.Result.formAnswerHtmlString;
                  _this44.checkInPostData.answerNotificationList = response.Result.answerNotificationList;
                }

                _this44.inductionNavigationProcess(userId, _this44.inductionContentItemIndex);
              }
        ...
        _createClass(SharedDataService, [{
          ...
          value: function saveFormAnswers(apiService, formGroup, formBuilderDetail, personalModeLoggedUser, callBack) {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee31() {
              ...
              var sections, requiredFieldsCount, requiredFieldsValidCount, filledFieldsCount, filledFieldsValidCount, attachmentCount, attachmentUploadedCount, attachemtUploaded, loading, errorMessage, missingFieldCount, _errorMessage, _errorMessage2;
                      ...
                      if (!_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].isWebApp) {
                          ...
                          sections.map(function (section, sectionIndex) {
                            ...
                            if (_this48.utilService.shouldShowSection(section)) {
                              if (section.isRiskAssessmentSection) {
                                ...
                                var questions = section.questions;
                                questions.map(function (question, questionIndex) {
                                  if (_this48.utilService.shouldShowQuestion(question)) {
                                    var controlName = _util_service__WEBPACK_IMPORTED_MODULE_5__["UtilService"].FCUniqueName(section, question);
                        ...
                        if (formGroup.valid && requiredFieldsCount === requiredFieldsValidCount) {
                                            ...
                                            if (question.selectedAnswerTypeId === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].CustomAnswerType.PhotoVideoUpload) {
                                              if (control && control.value) {
                                                ...
                                                this.utilService.dataUriToFile(control.value, fileName, mimeType).then(function (file) {
                                                  return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this49, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee29() {
                                                    var _this50 = this;
                                                  ...
                                                  if (attachmentCount === attachmentUploadedCount) {
                                                    ...
                                                    _this49.submitFormAnswers(apiService, formGroup, formBuilderDetail, personalModeLoggedUser, callBack, havExposure, workPermitAnswer, attachemtUploaded);
                                                  }
                                                });
                                              }
                                            }
                          ...
                          if (missingFieldCount === 0 && filledFieldsCount !== filledFieldsValidCount) {
                            _errorMessage = "Incorrect data found, please check your answers.";
                            callBack(false, _errorMessage);
                          } else {
                            _errorMessage2 = missingFieldCount + " required fields are needed to be filled in.";
          ...
          value: function submitInductionCheckInData(apiService) {
            ...
            apiService.insertCheckInDetails(this.checkInPostData).subscribe(function (response) {
              ...
              if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                _this51.observablesService.publishSomeData(_enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ObserverKeys.NEW_CHECKED_IN, response.Result);

                var suucessScreen = _this51.dedicatedMode ? "/checkinout-success-dm" : "/checkin-success";

                _this51.navCtrl.navigateForward([suucessScreen], {
                  queryParams: {
              ...
              _this51.processCheckInError(error, nextScreen);
            });
          }
        }, {
                  ...
                  switch (_context32.prev = _context32.next) {
                    case 0:
                      ...
                      apiService.insertCheckInDetailsGuest(this.checkInPostData).subscribe(function (response) {
                        ...
                        if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                          _this52.navCtrl.navigateForward(["/checkinout-success-dm"], {
                            queryParams: {
                              message: "You have now checked-in",
                              nextPage: nextScreen,
                              actionBtnTitle: "Continue"
                  ...
                  switch (_context33.prev = _context33.next) {
                    ...
                    case 19:
                      apiService.insertPersonalModeSignOffDetails(this.signOffDetailsPostData).subscribe(function (response) {
                        ...
                        if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                          if (_this53.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.FORM_ACTIVITY || _this53.signOffFor === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].SignOffType.DOCUMENT_ACTIVITY) {
                            _this53.observablesService.publishSomeData(_enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ObserverKeys.ACTIVITY_COMPLETED, true);
                          ...
                          if (isWorkPermitCurrentCheckin || isworkPermitActivity) {
                            if (_this53.workPermitAnswer.scoreAchieved >= _this53.workPermitAnswer.totalScore) {
                              _this53.navCtrl.navigateForward([checkInSuccessPage], {
                                queryParams: {
                                  title: "Passed",
                              ...
                              _this53.navCtrl.navigateForward([checkInFailPage], {
                                queryParams: {
                                  title: "Not Passed",
                ...
                if (inductionContentItem.contentType === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].InductionContentTypes.FORM) {
                  if (this.dedicatedMode) {
                    ...
                    this.apiServiceRerence.getDedicatedModeSignOffFormDetail(inductionContentItem.formID).subscribe(function (response) {
                      ...
                      if (response.StatusCode === _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ApiResponseCode.RequestSuccessful) {
                        _this54.viewFormFor = _enum_service__WEBPACK_IMPORTED_MODULE_2__["EnumService"].ViewFormForType.Induction;
                        _this54.signOffFormDetail = response.Result;
                        _this54.inductionContentItemIndex = inductionContentItemIndex + 1;

                        _this54.navCtrl.navigateForward(_util_service__WEBPACK_IMPORTED_MODULE_5__["UtilService"].InductionContentTypeScreenIdentify(inductionContentItem.contentType, _this54.dedicatedMode), {
                          queryParams: {
                            inductionContentItemIndex: _this54.inductionContentItemIndex
                          },
                          replaceUrl: true
                        });
                      }
                    ...
                    case 0:
                      ...
                      this.http.downloadFile(fileUrl, {}, {}, this.file.dataDirectory + fileName).then(function (response) {
                        ...
                        if (extension.toLowerCase() === 'pdf' || openInDefaultApp) {
                          _this55.fileOpener.open(url, mimeType).then(function () {
                            return console.log('File is opened');
                          })["catch"](function (e) {
                            return console.log('Error opening file', e);
                          });
                        } else if (_this55.platform.is('ios')) {
                          _this55.fileOpener.open(url, mimeType).then(function () {
                            return console.log('File is opened');
                          })["catch"](function (e) {
                            return console.log('Error opening file', e);
                          ...
                          _this55.fileOpener.showOpenWithDialog(url, mimeType).then(function () {
                            return console.log('File is opened');
                          })["catch"](function (e) {
                            return console.log('Error opening file', e);
                          });
