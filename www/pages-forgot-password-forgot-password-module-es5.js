  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-forgot-password-forgot-password-module"], {
    ...
    function cZHL(module, __webpack_exports__, __webpack_require__) {
      ...
      var ForgotPasswordPage = /*#__PURE__*/function () {
        function ForgotPasswordPage(utilService, accountService, navCtrl) {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      if (this.myForm.valid) {
                        ...
                        this.accountService.forgotpassword(email).subscribe(function (res) {
                          _this.utilService.hideLoading();

                          _this.navCtrl.navigateRoot('/linksend-success');
                        }, function (_ref) {
