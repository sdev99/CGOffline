(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-signoff-digitalink-signoff-digitalink-module"], {
    ...
    /***/
    function B0i5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SignoffDigitalinkPageRoutingModule", function () {
        return SignoffDigitalinkPageRoutingModule;
      });
      /* harmony import */
      ...
      var _signoff_digitalink_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./signoff-digitalink.page */
      "U50C");
      ...
      var SignoffDigitalinkPageRoutingModule = function SignoffDigitalinkPageRoutingModule() {
        _classCallCheck(this, SignoffDigitalinkPageRoutingModule);
      };

      SignoffDigitalinkPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function Dm7m(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SignoffDigitalinkPageModule", function () {
        return SignoffDigitalinkPageModule;
      });
      /* harmony import */
      ...
      var _signoff_digitalink_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./signoff-digitalink-routing.module */
      "B0i5");
      /* harmony import */


      var _signoff_digitalink_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./signoff-digitalink.page */
      "U50C");
      /* harmony import */
      ...
      var SignoffDigitalinkPageModule = function SignoffDigitalinkPageModule() {
        _classCallCheck(this, SignoffDigitalinkPageModule);
      };

      SignoffDigitalinkPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _signoff_digitalink_routing_module__WEBPACK_IMPORTED_MODULE_5__["SignoffDigitalinkPageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
    ...
    /***/
    function U50C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SignoffDigitalinkPage", function () {
        return SignoffDigitalinkPage;
      });
      /* harmony import */
      ...
      var _raw_loader_signoff_digitalink_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./signoff-digitalink.page.html */
      "hbDU");
      /* harmony import */


      var _signoff_digitalink_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./signoff-digitalink.page.scss */
      "gLum");
      /* harmony import */
      ...
      var fabric__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(fabric__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */
      ...
      var SignoffDigitalinkPage = /*#__PURE__*/function () {
        function SignoffDigitalinkPage(navCtrl, utilService, route, observablesService, sharedDataService, apiService, routerOutlet, accountService, screenOrientation, ngZone) {
          var _this = this;

          _classCallCheck(this, SignoffDigitalinkPage);
            ...
            if (_this.sharedDataService.dedicatedMode) {
              _this.screenOrientationSubscribe = _this.screenOrientation.onChange().subscribe(function () {
                _this.ngZone.run(function () {
                  ...
                  if (_this.showDigitalInk) {// this.initialiseDrawing();
                  }
                });
              });
            }
          ...
          this.isDigitalSignEmpty = function () {
            if (_this.canvasRef) {
              return _this.canvasRef.isEmpty();
            }
        ...
        _createClass(SignoffDigitalinkPage, [{
          key: "ngOnInit",
          ...
          key: "initialiseDrawing",
          value: function initialiseDrawing() {
            var _this2 = this;

            setTimeout(function () {
              if (!_this2.canvasRef) {
                var canvasRef = new fabric__WEBPACK_IMPORTED_MODULE_5__["fabric"].Canvas('digital-signature');
                _this2.canvasRef = canvasRef;
              } else {
                var _canvasRef = _this2.canvasRef;
                debugger;
              }

              if (_this2.sharedDataService.dedicatedMode || _this2.sharedDataService.isTablet) {
                var ele = document.getElementById('digital-signature');

                _this2.canvasRef.setDimensions({
              ...
              _this2.canvasRef.on('selection:created', function () {});

              _this2.canvasRef.on('selection:cleared', function () {});

              _this2.canvasRef.freeDrawingBrush.color = '#171538';
              _this2.canvasRef.freeDrawingBrush.width = 4;
              _this2.canvasRef.isDrawingMode = true;
            }, 200);
          }
        }, {
          ...
          value: function onContinue() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              ...
              var downlaodImg, fileName, mimeType;
                    ...
                    case 0:
                      ...
                      if (this.isConfirm) {
                        if (this.showDigitalInk) {
                          ...
                          fileName = 'signature' + this.utilService.getCurrentTimeStamp() + '.jpeg';
                          mimeType = 'image/jpeg';
                          this.utilService.presentLoadingWithOptions();
                          this.utilService.dataUriToFile(downlaodImg, fileName, mimeType).then(function (file) {
                            _this3.apiService.inductionSignatureUpload(file, fileName).subscribe(function (res) {
                              ...
                              _this3.errorMessage = error.message ? error.message : error;
                            });
                          }, function (error) {
                            _this3.utilService.hideLoading();
                          });
          ...
          value: function nextStep() {
            var signatureFileName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
            ...
            switch (this.type) {
              ...
              default: // if (this.sharedDataService.dedicatedMode) {
      ...
      SignoffDigitalinkPage.ctorParameters = function () {
        return [{
      ...
      SignoffDigitalinkPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function gLum(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hbDU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=pages-signoff-digitalink-signoff-digitalink-module-es5.js.map