(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-form-workpermit-form-workpermit-module"], {
    ...
    /***/
    function HJGP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JArB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FormWorkpermitPage", function () {
        return FormWorkpermitPage;
      });
      /* harmony import */
      ...
      var _raw_loader_form_workpermit_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./form-workpermit.page.html */
      "9dsd");
      /* harmony import */


      var _form_workpermit_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./form-workpermit.page.scss */
      "HJGP");
      /* harmony import */
      ...
      var _services_filehandler_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _modals_exit_confirmation_exit_confirmation_page__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ../../modals/exit-confirmation/exit-confirmation.page */
      "GR7D");
      /* harmony import */


      var _services_enum_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ../../services/enum.service */
      "AIDl");

      var FormWorkpermitPage = /*#__PURE__*/function () {
        function FormWorkpermitPage(navCtrl, photoService, sharedDataService, observablesService, modalController, route, filehandlerService, screenOrientation, ngZone, apiService, utilService, accountService) {
          var _this = this;

          _classCallCheck(this, FormWorkpermitPage);
        ...
        _createClass(FormWorkpermitPage, [{
          key: "ionViewDidEnter",
            ...
            if (this.formGroup.valid) {
              ...
              if (sections) {
                sections.map(function (section, sectionIndex) {
                  if (_this3.utilService.shouldShowSection(section)) {
                    var isSectionDuplicate = section[_services_enum_service__WEBPACK_IMPORTED_MODULE_17__["EnumService"].QuestionLogic.ActionTypeForForm.Duplicate];
                    var questions = section.questions;
                    questions.map(function (question, questionIndex) {
                      if (_this3.utilService.shouldShowQuestion(question)) {
                        ...
                        if (question.selectedAnswerTypeId === _services_enum_service__WEBPACK_IMPORTED_MODULE_17__["EnumService"].CustomAnswerType.SingleChoiceSet) {
                          var control = _this3.formGroup.controls[controlName];
                          ...
                          var _control = _this3.formGroup.controls[controlName];
                          var formGroups = _control.value;
                          question.answerChoiceAttributes.map(function (choice) {
                            var choiceControl = formGroups[_services_util_service__WEBPACK_IMPORTED_MODULE_14__["UtilService"].SubFCName(controlName, choice.answerChoiceAttributeId)];
      ...
      FormWorkpermitPage.ctorParameters = function () {
        return [{
      ...
      FormWorkpermitPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function YaHL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FormWorkpermitPageModule", function () {
        return FormWorkpermitPageModule;
      });
      /* harmony import */
      ...
      var _form_workpermit_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./form-workpermit-routing.module */
      "fBpu");
      /* harmony import */


      var _form_workpermit_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./form-workpermit.page */
      "JArB");
      /* harmony import */
      ...
      var FormWorkpermitPageModule = function FormWorkpermitPageModule() {
        _classCallCheck(this, FormWorkpermitPageModule);
      };

      FormWorkpermitPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _form_workpermit_routing_module__WEBPACK_IMPORTED_MODULE_5__["FormWorkpermitPageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
    ...
    /***/
    function fBpu(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FormWorkpermitPageRoutingModule", function () {
        return FormWorkpermitPageRoutingModule;
      });
      /* harmony import */
      ...
      var _form_workpermit_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./form-workpermit.page */
      "JArB");
      ...
      var FormWorkpermitPageRoutingModule = function FormWorkpermitPageRoutingModule() {
        _classCallCheck(this, FormWorkpermitPageRoutingModule);
      };

      FormWorkpermitPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=pages-form-workpermit-form-workpermit-module-es5.js.map