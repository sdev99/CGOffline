(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["checkin-workpermit-checkin-workpermit-module"], {
    ...
    function bkz(module, __webpack_exports__, __webpack_require__) {
      ...
      var CheckinWorkpermitPage = /*#__PURE__*/function () {
        function CheckinWorkpermitPage(navController, sharedDataService, utilService, apiService, navCtrl, accountService) {
                      ...
                      if (this.sharedDataService.dedicatedMode) {
                        ...
                        this.apiService.getDedicatedModeSignOffFormDetail(form.formID).subscribe(function (response) {
                          ...
                          if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiResponseCode.RequestSuccessful) {
                            _this.sharedDataService.signOffFor = _services_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].SignOffType.FORMS_DM;
                            _this.sharedDataService.viewFormFor = _services_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ViewFormForType.WorkPermitDM;
                            _this.sharedDataService.signOffFormDetail = response.Result;
                            _this.sharedDataService.dedicatedModeTempAuthFor = _services_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].DedicatedModeTempAuthType.WorkPermit;

                            _this.navController.navigateForward('/form-open-auth-dm');
                          }
                        }, function (error) {
                          _this.utilService.hideLoading();
                        });
                      } else {
                        _place = this.sharedDataService.currentSelectedCheckinPlace;
                        this.apiService.getSignOffFormDetail((_a = this.user) === null || _a === void 0 ? void 0 : _a.userId, form.formID, _place === null || _place === void 0 ? void 0 : _place.locationID, _place === null || _place === void 0 ? void 0 : _place.projectID, _place === null || _place === void 0 ? void 0 : _place.inventoryItemID).subscribe(function (response) {
                          _this.utilService.hideLoading();

                          if (response.StatusCode === _services_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ApiResponseCode.RequestSuccessful) {
                            _this.sharedDataService.viewFormFor = _services_enum_service__WEBPACK_IMPORTED_MODULE_6__["EnumService"].ViewFormForType.CurrentCheckinWorkPermit;
                            _this.sharedDataService.signOffFormDetail = response.Result;

                            _this.navCtrl.navigateForward(['/form-cover'], {
                              replaceUrl: true
                            });
                          }
                        }, function (error) {
      ...
      CheckinWorkpermitPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
...
//# sourceMappingURL=checkin-workpermit-checkin-workpermit-module-es5.js.map