(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-dashboard-dm-dashboard-dm-module"], {
    ...
    /***/
    function FA1B(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DashboardDmPage", function () {
        return DashboardDmPage;
      });
      /* harmony import */
      ...
      var _raw_loader_dashboard_dm_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./dashboard-dm.page.html */
      "Lne+");
      /* harmony import */


      var _dashboard_dm_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./dashboard-dm.page.scss */
      "Nv9F");
      /* harmony import */
      ...
      var DashboardDmPage = /*#__PURE__*/function () {
        function DashboardDmPage(navController, sharedDataService, apiService, accountService) {
          _classCallCheck(this, DashboardDmPage);
        ...
        _createClass(DashboardDmPage, [{
          ...
          value: function ngOnInit() {
            ...
            var companyFolderName = (_a = this.dedicatedModeDeviceDetailData) === null || _a === void 0 ? void 0 : _a.companyFolderName; // const companyFolderName = 'B01F4CF5-C26C-4C8F-BE94-A7C68FEDE752';

            this.apiService.getGlobalDirectories(companyFolderName).subscribe(function (response) {
              if (response) {
                _this.sharedDataService.globalDirectories = response;
      ...
      DashboardDmPage.ctorParameters = function () {
        return [{
      ...
      DashboardDmPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Lne(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Nv9F(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Zhrm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DashboardDmPageModule", function () {
        return DashboardDmPageModule;
      });
      /* harmony import */
      ...
      var _dashboard_dm_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./dashboard-dm-routing.module */
      "mKPt");
      /* harmony import */


      var _dashboard_dm_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./dashboard-dm.page */
      "FA1B");
      /* harmony import */
      ...
      var DashboardDmPageModule = function DashboardDmPageModule() {
        _classCallCheck(this, DashboardDmPageModule);
      };

      DashboardDmPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _dashboard_dm_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardDmPageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
    ...
    /***/
    function mKPt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DashboardDmPageRoutingModule", function () {
        return DashboardDmPageRoutingModule;
      });
      /* harmony import */
      ...
      var _dashboard_dm_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./dashboard-dm.page */
      "FA1B");
      ...
      var DashboardDmPageRoutingModule = function DashboardDmPageRoutingModule() {
        _classCallCheck(this, DashboardDmPageRoutingModule);
      };

      DashboardDmPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=pages-dashboard-dm-dashboard-dm-module-es5.js.map