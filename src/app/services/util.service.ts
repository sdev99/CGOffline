...
export class UtilService {
  ...
  static FCUniqueName(section, question) {
    ...
    if (
      section &&
      section[EnumService.QuestionLogic.FormControlNamePreStringForUniqueName]
    ) {
      preString =
        preString +
        "" +
    ...
    if (
      question &&
      question[EnumService.QuestionLogic.FormControlNamePreStringForUniqueName]
    ) {
      preString =
        preString +
        "" +
  ...
  public shouldShowQuestion(question) {
    return question[EnumService.QuestionLogic.ActionTypeForForm.ShowForLogic]
      ? true
          ...
          havAssessmentTools.map(
            (havAssessmentTool, havAssessmentToolIndex) => {
              havAssessmentTool.questions.map((question, questionIndex) => {
                const elementId = UtilService.HtmlElementIdUq(
                  sectionIndex + "" + havAssessmentToolIndex,
                  questionIndex,
                  section.sectionId,
                  question.questionId
                );
        ...
        if (
          ...
          if (
            ...
            const valueToBeCompare =
              question.answerChoiceAttributes[questionChoiceSetSequence];
            // Check if condition meet
            const isSelectedAndMeet =
              questionChoiceSetTypeID ===
                EnumService.QuestionLogic.SingleMultipleChoiceOperationType
                  .Selected &&
            ...
            const checkBoxValueSelected =
              value[Object.keys(value)[questionChoiceSetSequence]];
            // Check if condition meet
            const isSelectedAndMeet =
              questionChoiceSetTypeID ===
                EnumService.QuestionLogic.SingleMultipleChoiceOperationType
            ...
            switch (question.selectedAnswerTypeId) {
              ...
              case EnumService.CustomAnswerType.DateTimeField:
                ...
                selectedValue = moment(value)
                  .utc()
                  .format(StaticDataService.dateTimeFormatAMPM);
              ...
              case EnumService.CustomAnswerType.TimeField:
                ...
                valueToBeCompared =
                  timeValueSplit[0] + "" + (hourFormatID === 1 ? "AM" : "PM");
            ...
            if (
              ...
              ((questionOperatorTypeID ===
                EnumService.QuestionLogic.OtherValueOperationType.EqualTo &&
                selectedDateObj.isSame(dateObjToBeCompared)) ||
                (questionOperatorTypeID ===
                  EnumService.QuestionLogic.OtherValueOperationType.LessThen &&
                  selectedDateObj.isBefore(dateObjToBeCompared)) ||
                (questionOperatorTypeID ===
                  EnumService.QuestionLogic.OtherValueOperationType
                    .GreaterThen &&
                  selectedDateObj.isAfter(dateObjToBeCompared)) ||
                (questionOperatorTypeID ===
                  EnumService.QuestionLogic.OtherValueOperationType
                    .LessThenEqualTo &&
                  selectedDateObj.isSameOrBefore(dateObjToBeCompared)) ||
                (questionOperatorTypeID ===
                  EnumService.QuestionLogic.OtherValueOperationType
                    .GreaterThenEqualTo &&
                  selectedDateObj.isSameOrAfter(dateObjToBeCompared)) ||
                (questionOperatorTypeID ===
                  EnumService.QuestionLogic.OtherValueOperationType
                    .NotEqualTo &&
                  !selectedDateObj.isSame(dateObjToBeCompared)))
              ...
              (questionOperatorTypeID ===
                ...
                selectedValue < valueToBeCompared) ||
              (questionOperatorTypeID ===
                EnumService.QuestionLogic.OtherValueOperationType.GreaterThen &&
                selectedValue > valueToBeCompared) ||
              (questionOperatorTypeID ===
                EnumService.QuestionLogic.OtherValueOperationType
                  .LessThenEqualTo &&
              ...
              (questionOperatorTypeID ===
                ...
                selectedValue >= valueToBeCompared) ||
              (questionOperatorTypeID ===
                EnumService.QuestionLogic.OtherValueOperationType.NotEqualTo &&
                selectedValue !== valueToBeCompared)
            ) {
              isActionMeet = true;
            }
              ...
              if (isQuestionChanged) {
                for (
                  ...
                  if (
                    ...
                    questionItem["applied_relation_ids"].indexOf(
                      logic["applied_relation_id"]
                    ) != -1
                  ) {
  ...
  applyLogicOn(question, logic, sections, currentSectionIndex, formGroup) {
    if (
      ...
      logic.questionActionTypeID === EnumService.QuestionLogic.ActionType.Notify
    ) {
      ...
      question[EnumService.QuestionLogic.ActionTypeForForm.CreateNewActivity] =
        true;
    } else {
      ...
      if (sectionIndex >= 0) {
        ...
        for (let sectionKey = 0; sectionKey < sections.length; sectionKey++) {
          const sectionItem = sections[sectionKey];
          if (
            sectionItem[EnumService.QuestionLogic.ActionTypeForForm.Duplicate]
          ) {
            duplicateSectionCount++;
          }
      ...
      if (questionActionTypeID === EnumService.QuestionLogic.ActionType.Show) {
        ...
        questionActionTypeID === EnumService.QuestionLogic.ActionType.Hide
      ) {
        if (sectionObject) {
          sectionObject[
            EnumService.QuestionLogic.ActionTypeForForm.HideForLogic
        ...
        questionActionTypeID === EnumService.QuestionLogic.ActionType.Duplicate
      ) {
        if (sectionObject) {
        ...
        questionActionTypeID === EnumService.QuestionLogic.ActionType.Notify
      ) {
        if (sectionObject) {
          sectionObject[EnumService.QuestionLogic.ActionTypeForForm.Notify] =
            true;
          this.setUniqueRelationIdOnLogicAndQuestionOrSection(
            sectionObject,
            logic
          ...
          questionObject[EnumService.QuestionLogic.ActionTypeForForm.Notify] =
            true;
          this.setUniqueRelationIdOnLogicAndQuestionOrSection(
            questionObject,
            logic
