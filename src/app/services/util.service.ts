...
export class UtilService {
  ...
  addDynamicFormControlsIfNotExist(
    ...
    if (question.shouldShowOptionalComment) {
      const formControlAdditionalNote = UtilService.FCNameAdditioanlNoteUq(
        formControlName
      );
          ...
          if (
                    ...
                    sectionItem.questions.some((questionItem, questionKey) => {
                      ...
                      if (
                        ...
                        currentIndexOfSection =
                          sectionIndex + duplicateSectionCount;
            ...
            if (
              ...
              if (sectionObject) {
                ...
                sections[currentIndexOfSection].questions.map(
                  (questionInner, key) => {
                    const uniquePreString =
                      question.questionId + "" + logic.questionLogicId;
                    if (
