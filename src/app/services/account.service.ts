...
export class AccountService {
	...
	constructor(private router: Router, public sharedDataService: SharedDataService, private http: HttpClient, private navController: NavController, private platform: Platform) {
