...
export class ApiService {
  ...
  getTermsOfServices() {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetTermsOfServices}`
    );
  }

  getTimeZoneList() {
    return this.http
      .get(`${environment.apiUrl}/${EnumService.ApiMethods.GetTimeZoneList}`)
      .pipe(
        map((data: Response) => {
          if (
  ...
  getCompanyLanguageList(companyId) {
    return this.http
      .get(
        `${environment.apiUrl}/${EnumService.ApiMethods.GetCompanyLanguageList}/${companyId}`
      )
      .pipe(
        map((data: Response) => {
          if (
  ...
  getEntityByQRCode(qrCode) {
    ...
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetEntityByQRCode}?code=${qrCode}&companyID=${companyID}`
    );
  }
  ...
  getLocationItemList(companyId) {
    return this.http
      .get(
        `${environment.apiUrl}/${EnumService.ApiMethods.GetLocationItemList}/${companyId}`
      )
      .pipe(
        map((data: Response) => {
          if (
  ...
  getGlobalDirectories(companyFolderName) {
    return this.http
      .get(
        `${environment.apiUrl}/${EnumService.ApiMethods.GetGlobalDirectories}?companyFolderName=${companyFolderName}`
      )
      .pipe(
        map((data: Response) => {
          if (
  ...
  updatePushNotification(body, userId) {
    return this.http
      .put(
        `${environment.apiUrl}/${EnumService.ApiMethods.UpdatePushNotification}/${userId}`,
        body
      )
      .pipe(
        map((data: Response) => {
  ...
  checkInPhotoUpload(file, fileName = "") {
    ...
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.CheckInPhotoUpload}`,
      formData
    );
  }
  ...
  inductionPhotoUpload(file, fileName = "") {
    ...
    formData.append("file", file, fileName);
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InductionPhotoUpload}`,
      formData
    );
  }
  ...
  formPhotoOrVideoUpload(file, fileName = "") {
    ...
    formData.append("file", file, fileName);
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.FormPhotoOrVideoUpload}`,
      formData
    );
  }
  ...
  inductionSignatureUpload(file, fileName = "") {
    ...
    formData.append("file", file, fileName);
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InductionSignatureUpload}`,
      formData
    );
  }
  ...
  getActivityList(userId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetUserActivityList}/${userId}`
    );
  }
  ...
  getActivityDetail(activityId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetUserActivityDetail}/${activityId}`
    );
  }
  ...
  activityCompleted(userId, activityId) {
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.ActivityCompleted}?id=${userId}&activityIndividualID=${activityId}`,
      {}
    );
  }
  ...
  getActivitySignOffFormDetail(userId, formId, activityIndividualID) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetActivitySignOffFormDetail}?id=${userId}&formId=${formId}&activityIndividualID=${activityIndividualID}`
    );
  }
  ...
  getActivitySignOffDocumentDetail(documentId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetActivitySignOffDocumentDetail}/${documentId}`
    );
  }
  ...
  getDedicatedModeSignOffFormDetail(formId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetDedicatedModeSignOffFormDetail}?formID=${formId}`
    );
  }
  ...
  downloadDocument(filename, companyFolderName) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.DownloadDocument}?fileName=${filename}&companyFolderName=${companyFolderName}`
    );
  }
  ...
  getPersonalModeAvailableForms(userId, companyID) {
    const place: CheckedInDetailItem = this.sharedDataService
  ...
  getFormBuilderDetails(formId, formVersionId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetFormBuilderDetails}/${formId}?formVersionId=${formVersionId}`
    );
  }
  ...
  getUserCurrentCheckingDetails(userId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetUserCurrentCheckInDetails}/${userId}`
    );
  }
  ...
  getCheckInDetails(userId, entityId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetCheckInDetails}/${userId}?EntityID=${entityId}`
    );
  }
  ...
  getMySignedDocuments(userId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.MySignedDocuments}/${userId}`
    );
  }
  ...
  insertPersonalModeSignOffDetails(postBody: SignOffDetailsPostData) {
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InsertPersonalModeSignOffDetails}`,
      postBody
    );
  }
  ...
  insertCheckInDetails(postBody: CheckInPostData) {
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InsertCheckInDetails}`,
      postBody
    );
  }
  ...
  insertCheckInDetailsGuest(postBody: CheckInPostData) {
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InsertCheckInDetails_Guest}`,
      postBody
    );
  }
  ...
  insertCheckOutDetails(postBody: {
    ...
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InsertCheckOutDetails}`,
      postBody
    );
  }
  ...
  insertCheckOutDetails_Guest(postBody: {
    ...
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.InsertCheckOutDetails_Guest}`,
      postBody
    );
  }
  ...
  getCompanyUserList(companyId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetCompanyUserList}/${companyId}`
    );
  }
  ...
  getCompanyUserGroupList(companyId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetCompanyUserGroupList}/${companyId}`
    );
  }
  ...
  getManufacturerList(companyId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetManufacturerList}/${companyId}`
    );
  }
  ...
  getTypeList(companyId, manufacturerId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetTypeList}?companyID=${companyId}&manufacturerID=${manufacturerId}`
    );
  }
  ...
  getModelList(companyId, typeId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetModelList}?companyID=${companyId}&typeID=${typeId}`
    );
  }
  ...
  getUserTotalHAVExposureForToday(userId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetUserTotalHAVExposureForToday}/${userId}`
    );
  }
  ...
  saveFormAnswers(postBody) {
    return this.http.post(
      `${environment.apiUrl}/${EnumService.ApiMethods.SaveFormAnswers}`,
      postBody
    );
  }
  ...
  getAccidentBodyPartList() {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetAccidentBodyPartList}`
    );
  }
  ...
  getAccidentClassificationList() {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetAccidentClassificationList}`
    );
  }
  ...
  getAccidentTypeList() {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetAccidentTypeList}`
    );
  }
  ...
  getRiskRatingOptionList() {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetRiskRatingOptionList}`
    );
  }
  ...
  getDeviceEntityDetails(deviceId) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetDeviceEntityDetails}/${deviceId}`
    );
  }
  ...
  getUserByQRCode(qrCode) {
    ...
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetUserByQRCode}?code=${qrCode}&companyID=${companyID}`
    );
  }
  ...
  getUserAutoSuggest(companyId, prefix) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetUserAutoSuggest}?companyID=${companyId}&prefix=${prefix}`
    );
  }
  ...
  getGuestUserDetailByPhone(phone) {
    return this.http.get(
      `${environment.apiUrl}/${EnumService.ApiMethods.GetGuestUserDetailByPhone}?phone=${phone}`
    );
  }
  ...
  getDedicatedModeAvailableDocuments(companyID) {
    const dedicatedModeLocationUse: DeviceEntityDetail = this.sharedDataService
