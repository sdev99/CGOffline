...
export class ApiService {
    ...
    getTermsOfServices() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetTermsOfServices}`
        );
    }
    ...
    getTimeZoneList() {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetTimeZoneList}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    getCompanyLanguageList(companyId) {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCompanyLanguageList}/${companyId}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    getCompanyLanguageTemplate() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCompanyLanguageTemplate}`
        );
    }

    getCompanyLanguageTemplateByCode(code) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCompanyLanguageTemplateByCode}?code=` +
                code
        );
    }
    ...
    getEntityByQRCode(qrCode) {
        ...
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetEntityByQRCode}?code=${qrCode}&companyID=${companyID}`
        );
    }
    ...
    getAnswerChoiceEntityByQRCode(qrCode) {
        ...
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetAnswerChoiceEntityByQRCode}?${queryString}`
        );
    }
    ...
    getLocationItemList(companyId) {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetLocationItemList}/${companyId}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    /**
     * This API will return full path of the user's directory files
     * @param fileName
     * @returns
     */
    getUserDirectoryFilePath(fileName) {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserDirectoryFilePath}?fileName=${fileName}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    /**
     * This API will return full path of the user check/signoff directory files
     * @param fileName
     * @returns
     */
    getUserCheckInSignOffDirectoryFilePath(fileName) {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserCheckInSignOffDirectoryFilePath}?fileName=${fileName}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    /**
     * This API will return full path of the company directory files
     * @param fileName
     * @returns
     */
    getCompanyDirectoryFilePath(fileName) {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCompanyDirectoryFilePath}?fileName=${fileName}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    /**
     * This API will return full path of the inventory directory files
     * @param fileName
     * @returns
     */
    getInventoryDirectoryFilePath(fileName) {
        return this.http
            .get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetInventoryDirectoryFilePath}?fileName=${fileName}`
            )
            .pipe(
                map((data: Response) => {
                    if (
    ...
    /**
     * This API will return full path of the document directory files
     * @param fileName
     * @returns
     */
    ...
    updatePushNotification(body, userId) {
        return this.http
            .put(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.UpdatePushNotification}/${userId}`,
                body
            )
            .pipe(
                map((data: Response) => {
    ...
    checkInPhotoUpload(file, fileName = "") {
        ...
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.CheckInPhotoUpload}`,
            formData
        );
    }
    ...
    inductionPhotoUpload(file, fileName = "") {
        ...
        formData.append("file", file, fileName);
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InductionPhotoUpload}`,
            formData
        );
    }
    ...
    formPhotoOrVideoUpload(file, fileName = "") {
        ...
        formData.append("file", file, fileName);
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.FormPhotoOrVideoUpload}`,
            formData
        );
    }
    ...
    inductionSignatureUpload(file, fileName = "") {
        ...
        formData.append("file", file, fileName);
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InductionSignatureUpload}`,
            formData
        );
    }
    ...
    getActivityList(userId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserActivityList}/${userId}`
        );
    }
    ...
    getActivityDetail(activityId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserActivityDetail}/${activityId}`
        );
    }
    ...
    getActivitySignOffFormDetail(userId, formId, activityIndividualID) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetActivitySignOffFormDetail}?id=${userId}&formId=${formId}&activityIndividualID=${activityIndividualID}`
        );
    }
    ...
    getActivitySignOffDocumentDetail(documentId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetActivitySignOffDocumentDetail}/${documentId}`
        );
    }
    ...
    getDedicatedModeSignOffFormDetail(formId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetDedicatedModeSignOffFormDetail}?formID=${formId}`
        );
    }
    ...
    downloadDocument(filename, companyFolderName) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.DownloadDocument}?fileName=${filename}&companyFolderName=${companyFolderName}`
        );
    }
    ...
    getPersonalModeAvailableForms(userId, companyID, folderId = 0) {
        ...
        if (
            companyID &&
            place &&
            (place.locationID || place.projectID || place.inventoryItemID)
        ) {
            const queryParam = {
                CompanyID: companyID,
            ...
            const queryString = UtilService.convertToQuerystring(queryParam);
            return this.http.get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetPersonalModeAvailableForms}/${userId}?${queryString}`
            );
        }
    ...
    getPersonalModeAvailableDocuments(userId, companyID, folderId = 0) {
        ...
        if (
            ...
            const queryString = UtilService.convertToQuerystring(queryParam);
            return this.http.get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetPersonalModeAvailableDocuments}/${userId}?${queryString}`
            );
        }
        return new Observable((observer: Observer<any>) => {
            observer.error(new Error("No current checkin found"));
    ...
    getPersonalModeAvailableWorkPermits(userId, companyID, folderId = 0) {
        ...
        if (
            ...
            const queryString = UtilService.convertToQuerystring(queryParam);
            return this.http.get(
                `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetPersonalModeAvailableWorkPermits}/${userId}?${queryString}`
            );
        }
        return new Observable((observer: Observer<any>) => {
            observer.error(new Error("No current checkin found"));
    ...
    getFormBuilderDetails(formId, formVersionId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetFormBuilderDetails}/${formId}?formVersionId=${formVersionId}`
        );
    }
    ...
    getUserCurrentCheckingDetails(userId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserCurrentCheckInDetails}/${userId}`
        );
    }
    ...
    getCheckInDetails(userId, entityId) {
        ...
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCheckInDetails}/${userId}?EntityID=${entityId}`,
            {
                headers: {
                    companyFolderName,
                },
    ...
    getMySignedDocuments(userId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.MySignedDocuments}/${userId}`
        );
    }
    ...
    insertPersonalModeSignOffDetails(postBody: SignOffDetailsPostData) {
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InsertPersonalModeSignOffDetails}`,
            postBody
        );
    }

    /**
     *  This API will use for Activity & Document/Form sign off test html in development mode only for use developers, it will call only when click on test html button on singoff page
     * @param postBody SignOffDetailsPostData
     */
    insertPersonalModeSignOffDetailsTest(postBody: SignOffDetailsPostData) {
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InsertPersonalModeSignOffDetails_Test}`,
            postBody
        );
    }
    ...
    insertCheckInDetails(postBody: CheckInPostData) {
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InsertCheckInDetails}`,
            postBody
        );
    }
    ...
    insertCheckInDetailsGuest(postBody: CheckInPostData) {
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InsertCheckInDetails_Guest}`,
            postBody
        );
    }
    ...
    insertCheckOutDetails(postBody: {
        ...
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InsertCheckOutDetails}`,
            postBody
        );
    }
    ...
    insertCheckOutDetails_Guest(postBody: {
        ...
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.InsertCheckOutDetails_Guest}`,
            postBody
        );
    }
    ...
    getCompanyUserList(companyId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCompanyUserList}/${companyId}`
        );
    }
    ...
    getCompanyUserGroupList(companyId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetCompanyUserGroupList}/${companyId}`
        );
    }
    ...
    getManufacturerList(companyId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetManufacturerList}/${companyId}`
        );
    }
    ...
    getTypeList(companyId, manufacturerId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetTypeList}?companyID=${companyId}&manufacturerID=${manufacturerId}`
        );
    }
    ...
    getModelList(companyId, typeId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetModelList}?companyID=${companyId}&typeID=${typeId}`
        );
    }
    ...
    getUserTotalHAVExposureForToday(userId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserTotalHAVExposureForToday}/${userId}`
        );
    }
    ...
    saveFormAnswers(postBody) {
        return this.http.post(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.SaveFormAnswers}`,
            postBody
        );
    }
    ...
    getAccidentBodyPartList() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetAccidentBodyPartList}`
        );
    }
    ...
    getAccidentClassificationList() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetAccidentClassificationList}`
        );
    }
    ...
    getAccidentTypeList() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetAccidentTypeList}`
        );
    }
    ...
    getRiskRatingOptionList() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetRiskRatingOptionList}`
        );
    }
    ...
    getRiskAssessmentProbabilityOptions() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetRiskAssessmentProbabilityOptions}`
        );
    }
    ...
    getRiskAssessmentSeverityOptions() {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetRiskAssessmentSeverityOptions}`
        );
    }
    ...
    getRiskItemList(companyId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetRiskItemList}/${companyId}`
        );
    }
    ...
    getHazardItemList(companyId, riskItemId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetHazardItemList}?companyID=${companyId}&companyRiskItemID=${riskItemId}`
        );
    }
    ...
    getDeviceEntityDetails(deviceId) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetDeviceEntityDetails}/${deviceId}`
        );
    }
    ...
    getUserByQRCode(qrCode) {
        ...
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserByQRCode}?code=${qrCode}&companyID=${companyID}`
        );
    }
    ...
    getUserAutoSuggest(companyId, prefix) {
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetUserAutoSuggest}?companyID=${companyId}&prefix=${prefix}`
        );
    }
    ...
    getGuestUserDetailByPhone(phone) {
        ...
        const queryString = UtilService.convertToQuerystring(queryParam);
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetGuestUserDetailByPhone}?${queryString}`
        );
    }
    ...
    getDedicatedModeAvailableDocuments(companyID, folderId = 0) {
        ...
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetDedicatedModeAvailableDocuments}?${queryString}`
        );
    }
    ...
    getDedicatedModeAvailableForms(companyID, folderId = 0) {
        ...
        const queryString = UtilService.convertToQuerystring(queryParam);
        return this.http.get(
            `${this.sharedDataService.apiBaseUrl}/${EnumService.ApiMethods.GetDedicatedModeAvailableForms}?${queryString}`
        );
    }
