...
export class DashboardHeaderComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.observablesService
            ...
            .subscribe(() => {
                this.ngZone.run(() => {
                    this.setupCurrentCheckedInPlaces(
        ...
        this.checkedPlaces.map((place, key) => {
            if (
                ...
                sharedDataService.currentSelectedCheckinPlace
                    ?.userCheckInDetailID
            ) {
        ...
        if (checkedInPlaces && checkedInPlaces.length > 0) {
            if (this.selectedPlace) {
                ...
                checkedInPlaces.map((item: CheckedInDetailItem) => {
                    if (
                        this.selectedPlace.userCheckInDetailID ===
    ...
    previousPlace() {
        if (this.currentCheckinPlaceIndex > 0) {
            ...
            this.placedChange(
                this.checkedPlaces[this.currentCheckinPlaceIndex]
            );
        }
    }
