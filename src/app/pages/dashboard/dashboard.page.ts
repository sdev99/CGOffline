...
export class DashboardPage implements OnInit, OnDestroy {
    ...
    checkLocationArchive = () => {
        ...
        if (this.sharedDataService.currentSelectedCheckinPlace?.locationID) {
            ...
            this.sharedDataService.currentSelectedCheckinPlace?.inventoryItemID
        ) {
            ...
            (response: Response) => {
                if (
                    ...
                    if (result) {
                        ...
                        this.sharedDataService.activityList =
                            result.activityList;
