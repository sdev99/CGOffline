...
export class CheckinoutConfirmPage implements OnInit {
	...
	async onContinue() {
		const nowCheckoutOutKey = 'PAGE.CHECKINOUT.YOU_HAVE_NOW_CHECKED_OUT';
		const continueKey = 'COMMON.CONTINUE';
		const cannotCheckoutKey = 'PAGE.CHECKINOUT.YOU_CANNOT_CHECK_OUT';
