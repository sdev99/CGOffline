...
export class FormAccidentReportPage {
    ...
    getLocationItemList = () => {
        this.apiService.getLocationItemList(this.companyId).subscribe((res) => {
