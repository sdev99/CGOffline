...
export class CheckinoutPhotoidentityDmPage implements OnInit {
    ...
    startCamera = () => {
        if (this.isWebApp) {
            ...
            const cameraPreviewOpts: CameraPreviewOptions = {
                ...
                toBack: true,
                alpha: 1,
                disableExifHeaderStripping: disableExifHeaderStripping
                    ? true
                    : false,
            };
    ...
    onContinue(isGenerateTestJsonFile = false) {
        if (this.sharedDataService.offlineMode && !isGenerateTestJsonFile) {
            ...
            switch (this.sharedDataService.checkinoutDmAs) {
                case EnumService.CheckInType.AS_GUEST:
                    if (this.sharedDataService.offlineMode) {
                        ...
                        this.sharedDataService.checkInPostData.guestPhoto =
                            photoName;
                    }
                    break;
                case EnumService.CheckInType.MY_NAME:
                    if (this.sharedDataService.offlineMode) {
                        ...
                        this.sharedDataService.checkInPostData.userPhoto =
                            photoName;
                    }
                    break;
            }
