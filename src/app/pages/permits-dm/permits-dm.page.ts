...
export class PermitsDmPage implements OnInit {
	...
	constructor(public utilService: UtilService, public sharedDataService: SharedDataService, public apiService: ApiService, public offlineManagerService: OfflineManagerService) {}
	...
	getDedicatedModeLiveWorkPermits() {
		...
		if (this.sharedDataService.offlineMode) {
			this.offlineManagerService.getDeviceLiveWorkPermits(this.sharedDataService.dedicatedModeLocationUse).then((res) => {
				if (res) {
	...
	getDedicatedModeArchiveWorkPermits() {
		...
		const companyID = this.sharedDataService.dedicatedModeDeviceDetailData?.companyID;
		if (this.sharedDataService.offlineMode) {
			this.offlineManagerService.getDeviceArchivedWorkPermits(this.sharedDataService.dedicatedModeLocationUse).then((res) => {
