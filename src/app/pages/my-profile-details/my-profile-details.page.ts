...
export class MyProfileDetailsPage implements OnInit {
	...
	constructor(public navCtrl: NavController, public sharedDataService: SharedDataService, private accountService: AccountService, public utilService: UtilService) {
		...
		if (this.profile) {
			...
			this.languageData = UtilService.findObj(sharedDataService.companyLanguageList, 'companyLanguageID', this.profile.mobileAppLanguageID);
		}
	}
