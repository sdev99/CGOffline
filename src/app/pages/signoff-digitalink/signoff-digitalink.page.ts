...
export class SignoffDigitalinkPage implements OnInit {
        ...
        this.translateService
            ...
            .subscribe((res) => {
                switch (this.type) {
                    ...
                    case EnumService.SignOffType.DOCUMENT_CURRENT_CHECKIN:
                        this.aggrementTitle =
                            res[documentActivityAgreementTitleLangKey];
                    ...
                    case EnumService.SignOffType.FORM_ACTIVITY:
                    case EnumService.SignOffType.FORM_CURRENT_CHECKIN:
                    case EnumService.SignOffType
                        .WORKPERMIT_FORM_CURRENT_CHECKIN:
                        this.aggrementTitle =
                            res[formActivityAgreementTitleLangKey];
                    ...
                    default:
                        if (UtilService.isLocalHost()) {
                            ...
                            this.title = res[signOffLangKey];
                            this.aggrementTitle =
                                res[signOffAgreementTitleLangKey];
                            this.showDigitalInk = true;
                            this.initialiseDrawing();
                        }
                }
    ...
    onClose() {
        if (
            ...
            this.sharedDataService.signOffFor ===
            EnumService.SignOffType.FORMS_DM
        ) {
            this.navCtrl.back();
        } else if (
            this.sharedDataService.signOffFor ===
    ...
    async onContinue(isGenerateTestJsonFile = false) {
        this.errorMessage = "";
        ...
        if (this.isConfirm) {
            ...
            if (this.showDigitalInk) {
                ...
                if (
                    ...
                    this.utilService
                        .dataUriToFile(downlaodImg, fileName, mimeType)
                        .then(
                            (file) => {
                                this.apiService
                ...
                this.nextStep({}, isGenerateTestJsonFile);
            }
        }
    }
