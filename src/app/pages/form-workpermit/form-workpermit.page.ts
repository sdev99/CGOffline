...
export class FormWorkpermitPage {
  ...
  expireDateTypes = [
    {
      title:
        "PAGESPECIFIC_TEXT.FORM_LIST.SPECIFIC_FORMS.WORK_PERMIT_FORM.EXPIRATION_EXPIRES_ON",
      type: "date",
    },
    {
      title:
        "PAGESPECIFIC_TEXT.FORM_LIST.SPECIFIC_FORMS.WORK_PERMIT_FORM.EXPIRATION_EXPIRES_AFTER",
      type: "duration",
    },
  ];
  ...
  onSubmit() {
    ...
    if (this.formGroup.valid) {
      ...
      workPermitAnswer = {
        ...
        whoDefinesDateType:
          this.formBuilderDetail?.workPermitDetails?.whoDefinesDateType,
        hasExpiresOn: false,
        expiresOnDate: "",
